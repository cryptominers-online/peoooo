    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("PeopleCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  PeopleCoind [options]                     " + "\n" +
                  "  PeopleCoind [options] <command> [params]  " + _("Send command to -server or PeopleCoind") + "\n" +
                  "  PeopleCoind [options] help                " + _("List commands") + "\n" +
                  "  PeopleCoind [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "PeopleCoin:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: PeopleCoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: PeopleCoind.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 33813 or testnet: 5944)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 33812 or testnet: 5943)") + "\n" +
        ...
        "\n" + _("SSL options: (see the PeopleCoin Wiki for SSL setup instructions)") + "\n" +
